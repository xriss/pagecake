...
_M.basefunc.footer=function(html,d)
	...
	d.report=d.report or "Page generated by <a href=\"https://bitbucket.org/xixs/anlua\">anlua</a>"..mods.." in "..(d.time or 0).."("..(d.api_time or 0)..") seconds with "..((fetch.count or 0)+(data.count or 0)).." queries and "..(cache.count_got or 0).."/"..(cache.count or 0).." caches."
...
_M.basefunc.about=function(html,d)
	...
	d.aelua="<a href=\"https://bitbucket.org/xixs/anlua\">anlua</a>"
