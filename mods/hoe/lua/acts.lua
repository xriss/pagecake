...
default_props=
{
	...
	type="act",		-- the type of action for more general grouping
	
	dupe=0,			-- set to the id this act is a dupe of, or 0 if it is unique
						-- we record dupes for actions with multiple owners
	
	owner=0,			-- the player whoes profile this act should be displayed on
	private=0,			-- is this a private msgs? set to 0 if public or the player id if only intended for them
						-- so private==0 if we want a public stream
	
	actor1=0,			-- the primary actor or 0 if none
	actor2=0,			-- the secondary actor or 0 if none
}
...
--
--------------------------------------------------------------------------------
function add_namechange(srv,tab)
	local H=srv.H
...
--
--------------------------------------------------------------------------------
function add_tradeoffer(srv,tab)
	local H=srv.H
...
--
--------------------------------------------------------------------------------
function add_rob(srv,tab,fight)
	local H=srv.H
...
--
--------------------------------------------------------------------------------
function add_arson(srv,tab,fight)
	local H=srv.H
...
--
--------------------------------------------------------------------------------
function add_party(srv,tab,fight)
	local H=srv.H
