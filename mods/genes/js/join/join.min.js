require=(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"join":[function(require,module,exports){
module.exports=require('onm6mO');
},{}],"onm6mO":[function(require,module,exports){
var ls=function(n){console.log(util.inspect(n,{depth:null}))};exports.setup=function(i){var e={opts:i},o=require("./jquery.js");require("./jquery.cookie.js"),e.qs={};for(var t=window.location.href.slice(window.location.href.indexOf("?")+1).split("&"),s=0;s<t.length;s++){var a=t[s].split("=");e.qs[a[0]]=decodeURIComponent(a[1])}return e.vars={},e.vars.session=a.session||o.cookie("fud_session"),e.vars.token=a.token,e.userapi="http://api.wetgenes.com:1408/genes/user/",e.template=o("<div></div>"),e.fill=function(){o(i.div).empty().append(e.template.find(".wetjoin_main").clone()),e.qs.token?(e.vars.token=e.qs.token,e.page("token"),o(".wetjoin_main .wetjoin_submit").click()):(e.page("session"),o(".wetjoin_main .wetjoin_submit").click())},e.page=function(n){return o(".wetjoin").removeClass().addClass("wetjoin wetjoin_page_"+n),e.vars.token=o(".wetjoin_main .wetjoin_token").val()||e.vars.token,e.vars.name=o(".wetjoin_main .wetjoin_name").val()||e.vars.name,e.vars.email=o(".wetjoin_main .wetjoin_email").val()||e.vars.email,e.vars.pass=o(".wetjoin_main .wetjoin_pass").val()||e.vars.pass,e.vars.session=o(".wetjoin_main .wetjoin_session").val()||e.vars.session,o(".wetjoin_main .wetjoin_page").empty().append(e.template.find(".wetjoin_page_"+n).clone()),o(".wetjoin_main .wetjoin_token").val(e.vars.token),o(".wetjoin_main .wetjoin_name").val(e.vars.name),o(".wetjoin_main .wetjoin_email").val(e.vars.email),o(".wetjoin_main .wetjoin_pass").val(e.vars.pass),o(".wetjoin_main .wetjoin_session").val(e.vars.session),o(".wetjoin_main .span_token").text(e.vars.token),o(".wetjoin_main .span_name").text(e.vars.name),o(".wetjoin_main .span_email").text(e.vars.email),e.qs.dumid&&o(".wetjoin_main .span_website").text(e.qs.dumid.split("/")[2]||e.qs.dumid),e.bind(),!1},e.callback=function(i,t){if(t.error)return o(".wetjoin_main .wetjoin_error").text(t.error),void("session"==i&&e.page("login"));var s=function(i){var o="";for(n in i)o=o+"&"+n+"="+i[n];e.qs.dumid?e.page("dumid"):e.qs["continue"]&&(-1===e.qs["continue"].indexOf("?")&&(o="?"+o),window.location.href=e.qs["continue"]+o)};"join"==i?e.page("join2"):"login"==i?(e.vars.session=t.session,e.page("login2"),o.cookie("fud_session",e.vars.session,{expires:49,path:"/"}),s({S:e.vars.session})):"forgot"==i?e.page("forgot2"):"session"==i?(e.vars.name=t.name,e.page("login2"),s({S:e.vars.session})):"token"==i&&("update"==t.command?(e.vars.name=t.name||e.vars.name,e.vars.email=t.email||e.vars.email,e.page("login")):"create"==t.command&&(e.vars.name=t.name||e.vars.name,e.vars.email=t.email||e.vars.email,e.page("login")))},e.submit=function(n){o(".wetjoin_main .wetjoin_error").text("");var i=o(".wetjoin_main .wetjoin_token").val(),t=o(".wetjoin_main .wetjoin_name").val(),s=o(".wetjoin_main .wetjoin_email").val(),a=o(".wetjoin_main .wetjoin_pass").val();return"join"==n?(o.post(e.userapi+"create",{name:t,email:s,pass:a},function(n,i,o){return e.callback("join",n,i,o)},"json"),!1):"login"==n?(o("#form").submit(),o.post(e.userapi+"login",{name:t,pass:a},function(n,i,o){return e.callback("login",n,i,o)},"json"),!0):"forgot"==n?(o.post(e.userapi+"update",{email:s,pass:a},function(n,i,o){return e.callback("forgot",n,i,o)},"json"),!1):"token"==n?(o.post(e.userapi+"token",{token:i},function(n,i,o){return e.callback("token",n,i,o)},"json"),!1):"session"==n?(o.post(e.userapi+"session",{session:e.vars.session||""},function(n,i,o){return e.callback("session",n,i,o)},"json"),!1):void 0},e.dumid_confirm=function(n){return e.qs.dumid?window.location.href=n?-1===e.qs.dumid.indexOf("?")?e.qs.dumid+"?confirm="+e.vars.session:e.qs.dumid+"&confirm="+e.vars.session:e.qs.dumid+"&deny=1":e.page("login2"),!1},e.bind=function(){o(".wetjoin_main .wetjoin_header_join").off("click").on("click",function(){return e.page("join")}),o(".wetjoin_main .wetjoin_header_login").off("click").on("click",function(){return e.page("login")}),o(".wetjoin_main .wetjoin_header_forgot").off("click").on("click",function(){return e.page("forgot")}),o(".wetjoin_main .wetjoin_submit_login").off("click").on("click",function(){return e.submit("login")}),o(".wetjoin_main .wetjoin_submit_join").off("click").on("click",function(){return e.submit("join")}),o(".wetjoin_main .wetjoin_submit_forgot").off("click").on("click",function(){return e.submit("forgot")}),o(".wetjoin_main .wetjoin_submit_token").off("click").on("click",function(){return e.submit("token")}),o(".wetjoin_main .wetjoin_submit_session").off("click").on("click",function(){return e.submit("session")}),o(".wetjoin_main .wetjoin_confirm").off("click").on("click",function(){return e.dumid_confirm(!0)}),o(".wetjoin_main .wetjoin_deny").off("click").on("click",function(){return e.dumid_confirm(!1)}),o(".wetjoin_main input").off("keypress").on("keypress",function(n){return 13==n.which?(o(this).blur(),o(".wetjoin_main .wetjoin_submit").click(),!1):void 0})},e.template.load("join.template.html",e.fill),e};
},{"./jquery.cookie.js":3,"./jquery.js":4}],3:[function(require,module,exports){
